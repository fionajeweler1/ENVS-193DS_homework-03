...
c. 
Figure 1. Faster sleep onset tends to occur on days when activity goals are met. Each red or blue dot represents a single day, with the red circles showing days when the activity goal was not met and blue circles showing days when it was met. The black horizontal bars in each group represent the mean time to fall asleep. On average, participants fell asleep slightly faster on days when the daily recommended activity goal was met.
